<?php 
    function quandro_na_parede(){
        ?>
            <!-- Large modal -->
            <button class="b_quadro_na_parede disabled" data-toggle="modal" data-target=".iap_modal_quadro_na_parede" title = "Você pode visualizar o seu quadro na parede aqui!" disabled><span class=""></span><img src="<?php echo plugins_url('img/molduras_quadro_na_parede/couch-icon.svg', __FILE__ ); ?>" alt=""></button>
